...
**Fire a clone of your weapon — carrying your spell — straight out the blade.**
...
If you're installing manually (outside the in-game browser): extract the download and copy the
**SpellSword** folder into
`...\steamapps\common\Blade & Sorcery\BladeAndSorcery_Data\StreamingAssets\Mods\`, then restart
the game.

## Compatibility

- Blade & Sorcery **PCVR**, game version **1.0.0.0**. Not for Nomad / Quest.
- Uses only stock content, so it won't clash with other mods' assets.

## Source & credits

Open source (MIT): <https://github.com/tony-zeidan/blade-and-sorcery-spell-sword>
Made by **Tony Abou-Zeidan**. Built on **ThunderRoad** by WarpFrog. Unofficial fan mod.
